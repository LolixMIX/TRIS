...
const pers1 = new person_class_1.Person("Владимир", 23, person_class_1.PersType.PASSEGER, 15);
const pers2 = new person_class_1.Person("Пётр", 14, person_class_1.PersType.PASSEGER, 18);
const pers3 = new person_class_1.Person("Евгений", 55, person_class_1.PersType.PASSEGER, 10);
const pers4 = new person_class_1.Person("Степан", 20, person_class_1.PersType.PASSEGER, 7);
const pers5 = new person_class_1.Person("Алексей", 54, person_class_1.PersType.EMPLOYEE);
const pers6 = new person_class_1.Person("Кирилл", 30, person_class_1.PersType.PASSEGER, 13.2);
